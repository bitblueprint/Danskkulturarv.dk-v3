 ...
 */
?>
<video controls="controls" autoplay="true" preload="true" title="Video til <?php echo WPChaosClient::get_object()->title; ?>" style="width:100%;height:100%;" width="100%" height="100%">
<?php 
