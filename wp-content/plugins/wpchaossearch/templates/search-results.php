	...
	<div class="row search-results-top">
		...
		<div class="col-2">	
			<div class="dropdown sortby-dropdown pull-right">
				  <a class="sortby-link" id="dLabel" role="button" data-toggle="dropdown" data-target="#" href="#">Sorter efter <strong class="blue">relevans</strong>&nbsp;<i class="icon-caret-down"></i></a>
				  <ul class="dropdown-menu" role="menu" aria-labelledby="dropdownMenu">
				    <li><a tabindex="-1" href="#">Relevans</a></li>
				    <li><a tabindex="-1" href="#">Alfabetisk</a></li>
				    <li><a tabindex="-1" href="#">Antal visninger</a></li>
				  </ul>
			</div>
		</div>
		<div class="col-2">
